<template>
 <div class="px-56 bg-white">
    <div class="relative w-full shadow-md">
        ...
        <label for="cover" class="flex items-center my-2 mx-6 absolute right-0 bottom-0 px-4 py-2 bg-gray-100 hover:bg-gray-200 rounded-md shadow-sm cursor-pointer">
            <img src="/images/svg/camera.svg" class="w-4 h-4" title="choose cover photo">
            <span class="ml-1 text-gray-900 text-xs font-bold">Add Cover Photo</span>
        </label>
    ...
    <div class="flex">
        <div class="w-2/3 px-6 flex justify-around">
            <button @click="activeTab='timeline'" :class="[ activeTab=='timeline' ? ['text-blue-600','border-b-4','border-blue-600'] : ['hover:bg-gray-200','rounded-lg'] ]" class="mx-2 flex items-center justify-center p-3 text-gray-600 font-bold focus:outline-none transition-all duration-300 ease-out">Timeline</button>
            <button @click="activeTab='about'" :class="[ activeTab=='about' ? ['text-blue-600','border-b-4','border-blue-600'] : ['hover:bg-gray-200','rounded-lg'] ]" class="mx-2 flex items-center justify-center p-3 text-gray-600 font-bold focus:outline-none transition-all duration-300 ease-out">About</button>
            <button @click="activeTab='friends'" :class="[ activeTab=='friends' ? ['text-blue-600','border-b-4','border-blue-600'] : ['hover:bg-gray-200','rounded-lg'] ]" class="mx-2 flex items-center justify-center p-3 text-gray-600 font-bold focus:outline-none transition-all duration-300 ease-out">Friends</button>
